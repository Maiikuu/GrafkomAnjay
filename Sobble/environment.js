...
export function createEnvironment(GL, SHADER_PROGRAM, _position, _color) {
  ...
  // === GROUND - Tanah besar ===
  // Ukuran 15 -> 30
  const groundData = generateEllipsoid(30, 0.3, 30, 32, 8, GRASS_GREEN); // <-- MODIFIKASI
  const ground = new MyObject(
    GL,
    SHADER_PROGRAM,
    _position,
    _color,
